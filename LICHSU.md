...
| **KH4** | Xuất kho (quy trình 3 bước) | 🔄 Đang kiểm thử / chờ gộp |
| **KH5** | Điều chuyển giữa kho + Kiểm kê | ⏳ Chưa làm |
...
Còn lại: kiểm thử trên trình duyệt → review tổng thể → gộp vào bản chính.

## KH5 — Điều chuyển giữa kho + Kiểm kê ⏳

(Chưa làm) Chuyển vật tư giữa các kho/công trình; kiểm kê và điều chỉnh tồn cho khớp thực tế.
