...
>
> **Ngày cập nhật gần nhất:** 02/06/2026 — **đã hoàn thành toàn bộ lộ trình 6 kế hoạch.**
...
| **KH6** | Báo cáo + Xuất Excel/PDF | ✅ Hoàn thành (đã gộp master) |
...
Đã hoàn thành & gộp vào `master` (02/06/2026); test 130 pass, build production OK, đã qua review tổng thể (không có lỗi quan trọng). Gồm 4 phần (không đổi cấu trúc dữ liệu):

- **Báo cáo tồn kho + giá trị tồn:** trang Tồn kho hiển thị theo từng kho hoặc tổng hợp tất cả kho, kèm cột giá trị (tồn × đơn giá tham khảo) và tổng giá trị; nút **Xuất Excel**.
- **Lịch sử giao dịch:** tra cứu mọi biến động nhập/xuất/điều chuyển/kiểm kê, lọc theo thời gian/kho/vật tư/loại phiếu; nút **Xuất Excel**.
- **Trang Tổng quan:** thay trang chủ tạm — hiển thị số phiếu chờ duyệt (theo từng loại), phiếu xuất chờ ghi thực xuất, số liệu nhanh cho quản lý/kế toán.
- **In phiếu PDF:** nút "In phiếu" trên mọi phiếu (nhập/xuất/điều chuyển/kiểm kê) → trang in sạch có khu vực ký → dùng chức năng In của trình duyệt để lưu PDF.

---

## 🎉 Hoàn thành lộ trình

Toàn bộ 6 kế hoạch đã xong. Phần mềm đáp ứng đầy đủ quy trình kho cơ bản: quản lý người dùng/công trình/vật tư, nhập kho, xuất kho 3 bước, điều chuyển giữa kho, kiểm kê/điều chỉnh, báo cáo & in phiếu. Bước tiếp theo khi sẵn sàng: **triển khai lên đám mây** để dùng thực tế (xem mục "Triển khai" trong tài liệu thiết kế).
