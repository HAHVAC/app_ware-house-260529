...
| **KH5** | Điều chuyển giữa kho + Kiểm kê | 🔄 Đã có kế hoạch, chờ thực thi |
...
**Kế hoạch chi tiết đã viết** ([docs/superpowers/plans/2026-06-01-plan-5-transfer-stocktake.md](docs/superpowers/plans/2026-06-01-plan-5-transfer-stocktake.md)) — chưa thực thi. Gồm 2 tính năng (không cần đổi cấu trúc dữ liệu):
